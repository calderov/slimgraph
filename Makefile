all:
	...
	g++ -std=c++11 -isystem ./include demos/demo01.cpp include/graph.cpp -O3 -o build/bin/demo01
	g++ -std=c++11 -isystem ./include demos/demo02.cpp include/graph.cpp -O3 -o build/bin/demo02
